 ...
 * @param <EntityType>
 */
public class FindEntity<EntityType> extends AbstractStatement
{
	...
	public FindEntity(DatabaseService databaseService, Callable<EntityType> factory, String tableName, String columnName, String name) throws Exception
	{
	...
	public Optional<EntityType> execute(Object id) throws Exception
	{
		log.debug("execute", getName());

		assertRequired("id", id);

		return this.executeQuerySingleOrNoEntity(factory.call(), id);
	}
}
